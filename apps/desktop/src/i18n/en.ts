...
export const en: Translations = {
  ...
  browserPane: {
    ...
    copy: 'Copy selection from browser',
    paste: 'Paste clipboard into browser',
    disconnect: 'Disconnect',
  ...
  meetingPanel: {
    ...
    purposePrompt: 'What is this meeting about?',
    purposePlaceholder: 'John Smith initial interview for Client Job',
    summaryStyle: 'Summary style',
    summaryStyleInterview: 'Interview — candidate focused',
    summaryStyleInterviewHint: 'Preserves the substance, reasoning, tradeoffs, strengths, and gaps in candidate answers.',
    summaryStyleMeeting: 'Standard meeting',
    summaryStyleMeetingHint: 'Original overview, decisions, action items, questions, and notable details.',
